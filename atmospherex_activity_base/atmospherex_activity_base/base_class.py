...
class BaseActivityCustomCode(ABC):
    ...
    def send_mock_prediction_request(self, url_prediction_endpoint: str) -> Tuple[Response, dict]:
        """Send a mock request to the provided url and returns the corresponding response with extra information
        if required for computing the prediction.
        The response and dictionary will be provided to the `send_mock_outcome_request`."""
        pass
    ...
    def send_mock_outcome_request(self, url_outcome_endpoint: str, prediction_response: Response,
        ...
        """
        Send a mock request to the provided url and returns the corresponding response. Provide the prediction response
        and extra information created while creating the prediction request from `send_mock_prediction_request`.
        """
        pass
    ...
    def get_applied_exclusion_conditions(self, prediction_request: dict) -> AppliedExclusionConditionsResponse:
        """
        Define the exclusion rules for the activity
        """
